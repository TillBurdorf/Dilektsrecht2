...
Die folgende Ausarbeitung bietet eine abstrakte Darstellung der Voraussetzung von Verkehrssicherungspflichten und wann man ihnen genügt bzw. wann aus ihnen ein Schadensersatzanspruch aus § 823 1 BGB entsteht. Zusätzlich wird die besondere Haftung von Tieren samt Exkulpationsmöglichkeiten dargestellt.
...
#text(weight: "bold")[(II)]
Wenn der objektive Tatbestand bejaht werden kann, ist im nächsten Schritt notwendig, dass eine Rechtswidrigkeit vorliegt. Wie auch schon bei der Verletzungshandlung wird bei der Rechtswidrigkeit zwischen der unmittelbaren Schädigung durch aktives menschliches Tun und der mittelbaren Schädigung durch Unterlassen unterschieden #footnote[@sakowski_grundlagen_2020, 4.4.2.1.] .
...
#text(weight: "bold")[(II)]
Kausalität: Wie weiter oben bereits erwähnt, muss zusätzlich zur haftungsbegründenden Kausalität zwischen Handlung und Rechtsgutsverletzung auch eine Haftungsausfüllende Kausalität zwischen Rechtsgutsverletzung und Schaden bestehen #footnote[@looschelders_schuldrecht_2022, § 60 Rn 36.] . Diese wird analog mittels Äquivalenztheorie, Adäquanztheorie und dem Schutzzweck der Norm geprüft.
...
Wie bereits erläutert ist es nicht möglich völlig abstrakt darzustellen, welche Maßnahmen getroffen werden müssen um einer Verkehrssicherungspflicht zu genügen.
Nach übereinstimmender Meinung der Literatur liegt hier Wertungsrecht ohne eine vollkommende Rechtssicherheit vor #footnote[@krafft_kommunales_2016, 1.2 Rn 6.] .
Im Allgemeinen gilt, dass es notwendig ist diejenigen Maßnahmen zu ergreifen, "die ein umsichtiger und verständiger, in vernünftigen Grenzen vorsichtiger Mensch für notwendig und ausreichend hält". #emph(text(red)[BGH Urteil 299/13]) bzw "alle nach Lage der Verhältnisse erforderlichen Sicherungsmaßnahmen zum Schutz anderer Personen" #footnote[@fikentscher_schuldrecht_2022, § 107 III, Rn 1592.] . Bei Gefahren, die im Rahmen der Berufs oder Gewerbeausübung auftreten, wird hingegen von der "Sichtweise eines verständigen, umsichtigen, vorsichtigen und gewissenhaften Angehörigen der betreffenden Berufsgruppe" gesprochen #footnote[@looschelders_schuldrecht_2022, § 59 Rn 10.] .
Man genügt einer Verkehrspflicht somit, indem man einen Sicherheitsgrad erreicht, der entsprechend der im jeweiligen Bereich entsprechenden Verkehrsauffassung entsprechend ist. #footnote[BGH Urteil Rn. 9.]
...
Zudem müssen die Maßnahmen die getroffen werden allgemein und wirtschaftlich zumutbar sein. Die Maßnahmen sind dann zumutbar, wenn sie im  Verhältnis zum erstrebten Gefahrabwendungserfolg stehen #footnote[@krafft_kommunales_2016, 2.3.1.3.3 Rn 61.] . Hier wird auch die finanzielle Situation des Verkehrspflichtigen einbezogen, was allerdings keine völlige Pflichtbefreiung durch fehlende finanzielle Leistungsfähigkeit bedeutet #footnote[@krafft_kommunales_2016, 2.3.1.3.3 Rn 63] .
Desweiteren bestehen Sicherungspflichten nicht ausschließlich für den Bereich des eröffneten Verkehres, sondern auch für außerhalb liegende Gefahren, wenn diese in einem inneren Zusammenhang zum Verkehr stehen #footnote[@krafft_kommunales_2016, 2.3.1.3.6 Rn 70.] . 
...
Trotz des einfachen und nachvollziehbaren Grundsatzes ergeben sich im Hinblick auf die Verkehrssicherungspfichten einige rechtliche Schwierigkeiten und Besonderheiten die einem besonderen Blick erfordern.
Bereits der Begriff Verkehrssicherrungspflichten kann missverständlich sein, da es keineswegs nur um Sicherungspflichten im Straßenverkehr geht, sondern vielmehr um allgemeine Sorgfaltspflichten und Verhaltensgebote #footnote[@kotz_deliktsrecht_2017, 4 Rn 127.] .  
Desweiteren ist fraglich im Rahmen welches Schrittes der oben erläuterten Prüfung des § 823 1 die Verkehrspflichten zu verorten sind. Teile der Literatur arguementieren hier für eine Prüfung im Rahmen des Tatbestandes, andere für eine Prüfung im Rahmen der Rechtswidrigkeit.
...
In anderen Teilen der Literatur wird dieser Ansatz verworfen und die Verkehrspflichtverletzung als anderer Name für die Sorgfaltsgebote aus § 276 II definiert. #footnote[@kotz_deliktsrecht_2017, 4 Rn 129.] .

Aus der zusätzlichen Notwendigkeit die Verletzung einer Verkehrspflicht zu prüfen ergeben sich auch Unterschiede zur bereits erläuterten Anspruchsgrundlage auf Schadensersatz nach § 823 1 BGB.
