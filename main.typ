...
#show: project.with(
  ...
  title_long: "Deliktsrecht 2 Verkehrssicherungspflichten",
...
== Schaden
Der Geschädigte muss tatsächlich einen Schaden erlitten haben. Dieser kann sowohl materiell als auch immateriell sein. #footnote[@looschelders_schuldrecht_2022, § 60 Rn 36.] 

== Kausalität
Wie oben bereits erwähnt, muss zusätzlich zur Haftungsbegründenden Kausalität zwischen Handlung und Rechtsgutsverletzung auch eine Haftungsausfüllende Kausalität zwischen Rechtsgutsverletzung und Schaden bestehen. #footnote[@looschelders_schuldrecht_2022, § 60 Rn 36.]  Diese wird analog mittels Äquivalenztheorie, Adäquanztheorie und der Lehre des Schutzzwecks der Norm geprüft.

== Haftungsausschluss und Anspruchskürzungen
In Einzelfällen kann es zu vertraglichen oder gesetzlichen Haftungsausschlüssen kommen. Zusätzlich besteht die Möglichkeit, dass eine Mitschuld auf den geschädigten Entfällt, was zu einer Anspruchskürzung führt. Auch eine Verjährung ist denkbar. #footnote[@looschelders_schuldrecht_2022, § 60 Rn 37/38.] 
...
Die konkrete Definition der Verkehrspflichten geht nicht direkt aus dem Gesetz hervor, allerdings erfolgt die Definition in der Literatur und der ständigen Rechtsprechung. 
...
== Voraussetzungen von Verkehrssicherungspflichten
Als Voraussetzung für das Vorliegen einer Verkehrssicherungspflicht reicht eine abstrakte Gefahr jedoch nicht aus, sondern es muss eine "gefahrenträchtige Situation" vorliegen. Diese umfasst Situationen in denen eine Gefährdung unter nicht vollkommen abstrakten Umständen entsteht und für den Menschen absehbar ist. #footnote[@krafft_kommunales_2016, 2.3.1.2 Rn 55.]  Außerdem muss die Möglichkeit bestehen, dass ein Dritter dieser Gefahr auch tatsächlich ausgesetzt wird. Dies Entsteht im Normalfall durch die Verkehrseröffnung. #footnote[@krafft_kommunales_2016, 2.3.1.3.5 Rn 66.]  Dabei ist zu beachten, dass die Verkehrspflichten im Allgemeinen nur gegenüber Personen gelten, die befugt sind mit dem Verkehr in Kontakt zu geraten. Eine Ausnahme sind Kinder, welche auch dann geschützt werden müssen, wenn sie sich unbefugt nähern. #footnote[@looschelders_schuldrecht_2022, § 59 Rn 11.] 
...
Bereits der Begriff Verkehrssicherungspflicht kann missverständlich sein, da es keineswegs nur um Sicherungspflichten im Straßenverkehr geht, sondern vielmehr um allgemeine Sorgfaltspflichten und Verhaltensgebote. #footnote[@kotz_deliktsrecht_2017, E Teil 1.4 Rn 127.] Auch die Einordnung in der Prüfung des § 823 1 BGB und das Verhältnis zwischen Verkehrssicherungspflichten und Fahrlässigkeit sind strittig.
=== Einordnung der Verkehrssicherungspflichten in § 823 1 BGB   
Es ist fraglich im Rahmen welches Schrittes, der oben erläuterten Prüfung des § 823 1 BGB, die Verkehrspflichten zu verorten sind. Teile der Literatur argumentieren hier für eine Prüfung im Rahmen des Tatbestandes, andere für eine Prüfung im Rahmen der Rechtswidrigkeit.
...
In § 833 BGB ist die Haftung des Tierhalters für durch das Tier verursachte Rechtsgutsverletzungen geregelt. Konkret genannt werden die Tötung, die Verletzung von Körper oder Gesundheit oder die Beschädigung einer Sache durch ein Tier, welche gem. § 833 S. 1 einen Schadensersatzanspruch gegen denjenigen Begründet, der das Tier hält.
...
Der vertragliche Tieraufseher haftet gem. § 834 BGB durch Verschuldenshaftung. #footnote[@fikentscher_schuldrecht_2022, § 113 Rn 1687.]  Die Verschuldenshaftung gilt hier auch dann, wenn es sich bei dem betreffenden Tier um ein Nutztier handelt. #footnote[@looschelders_schuldrecht_2022, § 68 Rn 10.] Die Haftung aus Wild und Jagdschäden wird im Bundesjagdgesetz gesondert geregelt, wird hier aber aufgrund des Umfangs dieser Ausarbeitung nicht vertieft. #footnote[@fikentscher_schuldrecht_2022, § 113 Rn 1687.] 
