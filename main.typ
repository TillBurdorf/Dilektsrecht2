...
#text(weight: "bold")[(I)]
Die Prüfung des objektiven Tatbestandes lässt sich in drei Unterpunkte einteilen. Zuerst muss eine Rechtsgutsverletzung vorliegen, also die Verletzung von Leben, Körper, Gesundheit, Freiheit, Eigentum oder eines sonstigen absoluten Rechts (vgl. §823 1 BGB).
...
und ergibt sich aus dem Vertrauensgedanken #footnote[@krafft_kommunales_2016, 1.1 Rn 1.], dass ein Gefahrenbereich nur dann für dritte zugänglich gemacht wird, wenn die notwendigen Maßnahmen zur Schadensvermeidung getroffen wurden. 
...
== Voraussetzungen für Verkehrspflichten
...
Sollte das Vorliegen einer gefahrenträchtigen Situation gegeben sein, ist nach wie vor zu klären in welchem Umfang die Verkehrssicherungspflichten bestehen. Hierzu gibt es keine konkreten Regelungen im Gesetz, weswegen sich auf die gängige Rechtssprechung berufen werden muss. Der BGH bewertet den Umfang dieser an der Erforderlichkeit von Maßnahmen, der (wirtschaftlichen) Zumutbarkeit für den Verpflichteten und den berechtigten Sicherheitserwartungen des Verkehrs, welche sich am Umfang der Verkehrseröffnung und somit daran für wen und wo der Verkehr eröffnet wird orientiert #footnote[@krafft_kommunales_2016, 2.3.1.2 Rn 55.] .
...
Trotz des einfachen und nachvollziehbaren Grundsatzes ergeben sich im Hinblick auf die Verkehrssicherungspflichten einige rechtliche Schwierigkeiten und Besonderheiten die einem besonderen Blick erfordern.
...
Des Weiteren ist fraglich im Rahmen welches Schrittes der oben erläuterten Prüfung des § 823 1 die Verkehrspflichten zu verorten sind. Teile der Literatur argumentieren hier für eine Prüfung im Rahmen des Tatbestandes, andere für eine Prüfung im Rahmen der Rechtswidrigkeit.
...
== Begriffsklärungen 
#text(weight: "bold")[Tier]: Die Definition eines Tieres ist durch den allgemeinen Sprachgebrauch definiert. Die Literatur weist allerdings darauf hin, dass die Inklusion von Mikroorganismen wie Viren und Bakterien umstritten ist. Dafür spricht, dass Mikroorganismen lebendige Organismen sind und somit eine Nähe zum Wortsinn des Tieres bieten. Dagegen spricht allerdings, dass sie keine Lebewesen mit einem unberechenbaren Verhalten sind, welches eine wichtige Grundlage des §833 BGB ist #footnote[@looschelders_schuldrecht_2022, § 69 Rn 3.] .
