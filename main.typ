...
Wie bereits erläutert ist es nicht ganz einfach abstrakt festzulegen welche Maßnahmen getroffen werden müssen um einer Verkehrssicherungspflicht zu genügen.
Im Allgemeinen gilt, dass es notwendig ist diejenigen Maßnahmen zu ergreifen, "die ein umsichtiger und verständiger, in vernünftigen Grenzen vorsichtiger Mensch für notwendig und ausreichend hält". #emph(text(red)[BGH Urteil 299/13]) bzw "alle nach Lage der Verhältnisse erforderlichen Sicherungsmaßnahmen zum Schutz anderer Personen zu treffen" #footnote[@fikentscher_schuldrecht_2022, § 107 III, Rn 1592.] . Bei Gefahren, die im Rahmen der Berufs oder Gewerbeausübung auftreten, wird hingegen von der "Sichtweise eines verständigen, umsichtigen, vorsichtigen und gewissenhaften Angehörigen der betreffenden Berufsgruppe" gesprochen #footnote[@looschelders_schuldrecht_2022, § 59 Rn 10.] .
...
Bereits der Begriff Verkehrssicherrungspflichten kann missverstädnlich sein, da es keineswegs nur um Sicherungspflichten im Straßenverkehr geht, sondern vielmehr um allgemeine Sorgfaltspflichten und Verhaltensgebote #footnote[@kotz_deliktsrecht_2017, 4 Rn 127.] . Trotz dieses einfachen und nachvollziehbaren Grundsatzes ergeben sich im Hinblick auf die Verkehrssicherungspfichten allerdings einige rechtliche schwierigkeiten und Besonderheiten die einem besonderen Blick erfordern. 
...
Desweiteren bestehen unterschiedliche Auffassungen darüber, in welchem Zusammenhang sie zur allgemeinen Fahrlässigkeit aus § 276 II stehen #footnote[@kotz_deliktsrecht_2017, 4 Rn 124.] . Hier stellt sich die Frage, ob eine Verkehrspflichtverletzung dasselbe wie die Fahrlässigkeit darstellt, oder ob diese beiden zu Unterscheiden sind. 
