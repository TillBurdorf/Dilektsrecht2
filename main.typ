...
#text(weight: "bold")[(II)]
Wenn der objektive Tatbestand bejaht werden kann, ist im nächsten Schritt notwendig, dass die Rechtswidrigkeit vorliegt. Wie auch schon bei der Verletzungshandlung wird bei der Rechtswidrigkeit zwischen der unmittelbaren Schädigung durch aktives menschliches Tun und der mittelbaren Schädigung durch Unterlassen unterschieden #footnote[@sakowski_grundlagen_2020, 4.4.2.1.] .
...
Der Folgende Abschnitt behandelt die bereits erwähnten Verkehrssicherrungspflichten insbesondere im Hinblick darauf, wie sie entstehen, wann man ihnen genügt bzw wann daraus ein Schadensersatzanspruch aus § 823 1 BGB entsteht.
